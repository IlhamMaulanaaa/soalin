...
<head>
  ...
  <title>Daftar — SoalAI Intelligence</title>
  <meta name="description" content="Daftar ke platform SoalAI">
    ...
    <div class="card border-0 shadow-sm rounded-4 w-100" style="max-width: 420px;">
      <div class="card-body p-4 p-md-5">
        ...
        <form action="/register" method="post">
          ...
          <!-- Username -->
          <div class="mb-3">
            <label for="username" class="form-label small fw-semibold text-secondary mb-1">Username</label>
            <div class="input-group">
              <span class="input-group-text bg-light border-end-0 text-secondary rounded-start-3 px-3">
                <i class="bi bi-person"></i>
              </span>
              <input type="text" id="username" name="username" class="form-control bg-light border-start-0 ps-0 rounded-end-3 shadow-none" placeholder="nama_pengguna" value="<?= old('username') ?? '' ?>" required>
            </div>
          </div>
          ...
          <div class="text-center small text-secondary">
            Sudah punya akun? <a href="/login" class="text-decoration-none fw-semibold">Masuk Sekarang</a>
          </div>
        </form>
