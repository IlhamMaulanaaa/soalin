<header id="header" class="header fixed-top d-flex align-items-center">
  ...
  <div class="d-flex align-items-center justify-content-between">
    <a href="index.html" class="logo d-flex align-items-center">
      ...
      <span class="d-none d-lg-block">SOALin</span>
    </a>
    ...
    <ul class="d-flex align-items-center">
      ...
      <?php if (session()->get('logged_in')): ?>
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2"><?= esc(session()->get('email')) ?></span>
          </a><!-- End Profile Iamge Icon -->

          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
              <h6><?= esc(session()->get('email')) ?></h6>
      ...
      <?php else: ?>
        <li class="nav-item pe-3">
          <a class="btn btn-primary nav-profile d-flex align-items-center" href="/login"
            style="border-radius: 5px; padding: 5px 15px;">
            <span class="d-none d-md-block text-white">Login</span>
          </a>
        </li>
      <?php endif; ?>
